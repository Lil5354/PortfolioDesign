...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif", minHeight: "100vh", background: C.bgLight }}>
      <style>{`
