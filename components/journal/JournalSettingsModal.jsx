    ...
    <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-[#E0E0E0] bg-[#f8f8f8]">
          <h2 className="text-xl text-[#212121] flex items-center gap-2">
            Thiết lập tập san
          </h2>
        ...
        <div className="p-6">
          <h3 className="text-[#212121] mb-4">Chọn chiều trang</h3>
          ...
          <button 
            ...
            className="w-full py-3 bg-[#1a4ba8] text-white rounded-xl hover:bg-[#0d2e6e] transition-colors"
          >
            Bắt đầu thiết kế
          </button>
        </div>
