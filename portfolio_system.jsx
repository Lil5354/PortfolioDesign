              ...
              {["lecturer", "admin"].includes(authUser?.role) && (
                <div style={{ background: "#fff", border: "1px solid #EAEAEA", borderRadius: 8, padding: 24, marginBottom: 40, boxShadow: "0 2px 10px rgba(0,0,0,0.02)" }}>
                  ...
                  <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
                    <input type="number" min="0" max="10" step="0.1" value={gradeScore} onChange={e => setGradeScore(e.target.value)} placeholder={t("scoreLabel")} style={{ width: 100, padding: "12px", borderRadius: 6, border: "1px solid #CCC", outline: "none", fontSize: 14 }} />
                  ...
                  <button onClick={handleSaveGrade} onMouseDown={e => e.currentTarget.style.transform = "scale(0.95)"} onMouseUp={e => e.currentTarget.style.transform = "scale(1)"} onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"} style={{ background: "#191919", color: "#fff", border: "none", padding: "12px 24px", borderRadius: 20, fontSize: 14, fontWeight: "bold", cursor: "pointer", transition: "transform 0.1s" }}>
                    {t("submitGrade")}
                  </button>
                </div>
              )}
